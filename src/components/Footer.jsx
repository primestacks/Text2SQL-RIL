...
function Footer() {
  return (
    <div className="w-full  bg-primary py-20 max-h-[500px] ">
      <div className=" max-w-7xl my-0 grid grid-cols-1 md:grid-cols-3 lg:grid-cols-3 justify-start bg-[#3c2f72] rounded-2xl py-20 sm:mb-10 px-10 text-[#ffff] gap-5 mx-auto">
        <div className="">
