    ...
    <nav className="bg-primary w-full my-auto text-white p-4 font-secondary transition-all duration-300">
      <div className="max-w-7xl my-auto mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex justify-between h-16 items-center">
          ...
          <div className="hidden md:flex space-x-4">
            <button className="px-6 py-2 border border-seconday text-seconday rounded-lg hover:opacity-90 cursor-pointer">
              Login
            </button>
            <button className="px-6 py-2 bg-seconday rounded-lg hover:opacity-90 cursor-pointer">
              Sign Up
            </button>
          </div>
      ...
      >
        ...
        <div className="mt-2 px-4 space-y-2">
          <button className="w-full px-4 py-2 border border-seconday sm:block md:inline-block  rounded-lg hover:bg-white">
            Login
          </button>
